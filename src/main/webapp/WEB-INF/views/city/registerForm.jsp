...
<body>
	<h1>
		<spring:message code="city.register.title" arguments="[World]" /></h1>
...
<%-- 			<form:input path="countryCode" cssClass="form-control"/> --%>
			<form:select path="countryCode" cssClass="form-control">
				<form:option value="">----선택 하세요 ----</form:option>
...
<%-- 			<form:input path="district" cssClass="form-control"/> --%>
		...
		<!-- Submit -->
		<input class="btn btn-primary" type="submit" value="도시 추가 " />
	</form:form>
...
<script type="text/javascript">
	...
	$('#countryCode').change(function() {
		...
		console.log("change event called....value = " + $(this).val());
